...
<body>
    ...
    <h2 class="content-center">Lista de productos:</h2>
    
    <!-- Botón para agregar un nuevo producto -->
    <button class="new-product-button" onclick="window.location.href='/UACommerce/vendedor/regProduct.php'" style="padding: 10px 20px; font-size: 16px; cursor: pointer;">
        Nuevo Producto
    </button>
        ...
        fetch(apiUrl)
            ...
            .then(data => {
                ...
                data.forEach(producto => {
                    ...
                    editButton.classList.add('edit-button'); // Asignar clase para estilos
                    ...
                    deleteButton.classList.add('delete-button'); // Asignar clase
